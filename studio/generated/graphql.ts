...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    SupergraphForGraphRef(variables: SupergraphForGraphRefQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SupergraphForGraphRefQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SupergraphForGraphRefQuery>(SupergraphForGraphRefDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SupergraphForGraphRef', 'query');
    }
  };
}
